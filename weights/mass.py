...
def compute_y_cg(
    ...
    y_servo_front   = y_motor        # 2× front motors
    y_servo_aileron = y_rod_aileron  # 2× aileron spar
    y_servo_rear    = y_motor_back   # 1× rear motor
    y_servo_ht      = y_ht_spar      # 2× elevator spar
    y_servo_vt      = y_rod_aileron  # 1× rudder spar, base of VT at boom height
    y_servo_avg = (
        2 * y_servo_front
        + 2 * y_servo_aileron
        + 1 * y_servo_rear
